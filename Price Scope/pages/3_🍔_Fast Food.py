...
def calculate_price_delta(connection, product, start_date, end_date, period):
    ...
    previous_price = fetch_fastfood_price(connection, product, previous_start, previous_end)
    current_price = fetch_fastfood_price(connection, product, start_date, end_date)

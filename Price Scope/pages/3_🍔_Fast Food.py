...
def display_product_price(connection, product_name, enseigne_name, commune_name, period):
    ...
    # Récupérer le prix actuel moyen
    current_price = fetch_fastfood_price(connection, product_name, enseigne_name, commune_name, start_date, end_date)
...
def calculate_price_delta(connection, product_name, enseigne_name, commune_name, start_date, end_date, period):
    ...
    previous_price = fetch_fastfood_price(connection, product_name, enseigne_name, commune_name, previous_start, previous_end)
    current_price = fetch_fastfood_price(connection, product_name, enseigne_name, commune_name, start_date, end_date)

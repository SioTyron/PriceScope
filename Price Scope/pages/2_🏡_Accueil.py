...
st.markdown("""
    <div class="section">
        ...
        <p>
            ...
            Vous avez la possiblité d'ajouter un article en cliquant sur les boutons "Ajouter un article" dans les différentes pages de l'application.
        </p>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div class="section">
        ...
        <p>
            ...
            <a href="mailto:certificat.tyron@gmail.com">certificat.tyron@gmail.com</a>.
        </p>
    </div>
""", unsafe_allow_html=True)
